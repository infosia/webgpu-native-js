...
impl Runtime {
    ...
    #[must_use]
    pub fn native_render_bundle(&self, value: qjs::JSValue) -> Option<ffi_wgpu::WGPURenderBundle> {
...
mod tests {
    ...
    fn native_render_bundle_is_class_checked_and_borrows_the_native_handle() {
        ...
        let runtime = Runtime::new_with_dispatch(dispatch).expect("quickjs runtime");
        ...
        unsafe {
            qjs::JS_FreeValue(runtime.raw_context(), wrong);
            qjs::JS_FreeValue(runtime.raw_context(), bundle);
        }
    }
